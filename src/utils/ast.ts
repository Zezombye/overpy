...
export function isDefinitelyTruthy(content: Ast): boolean {
  ...
  if (content.name === "vect") {
    return (
      isDefinitelyTruthy(content.args[0]) ||
      isDefinitelyTruthy(content.args[1]) ||
      isDefinitelyTruthy(content.args[2])
    );
  }
...
export function astContainsFunctions(
  ast: Ast,
  ...
  if (functionNames.includes(ast.name)) {
    if (errorOnTrue) {
      error(
        "Cannot have the " + functionNameToString(ast) + " in this context",
      );
    }
    return true;
  }
...
export function getAstFor0_016() {
  return new Ast(
    "__number__",
    [new Ast("0.016", [], [], "UnsignedFloatLiteral")],
    [],
    "unsigned float",
  );
}
export function getAstFor0_001() {
  return new Ast(
    "__number__",
    [new Ast("0.001", [], [], "UnsignedFloatLiteral")],
    [],
    "unsigned float",
  );
}
export function getAstFor0_0001() {
  return new Ast(
    "__number__",
    [new Ast("0.0001", [], [], "UnsignedFloatLiteral")],
    [],
    "unsigned float",
  );
}
export function getAstFor255() {
  return new Ast(
    "__number__",
    [new Ast("255", [], [], "UnsignedIntLiteral")],
    [],
    "int",
  );
}
export function getAstFor10000() {
  return new Ast(
    "__number__",
    [new Ast("10000", [], [], "UnsignedIntLiteral")],
    [],
    "int",
  );
}
export function getAstFor10Million() {
  return new Ast(
    "__number__",
    [new Ast("10000000", [], [], "UnsignedIntLiteral")],
    [],
    "int",
  );
}
export function getAstForInfinity() {
  return new Ast(
    "__number__",
    [new Ast("999999999999", [], [], "UnsignedIntLiteral")],
    [],
    "unsigned int",
  );
}
export function getAstForMinusInfinity() {
  return new Ast(
    "__number__",
    [new Ast("-999999999999", [], [], "SignedIntLiteral")],
    [],
    "signed int",
  );
}
export function getAstForE() {
  return new Ast(
    "__number__",
    [new Ast("2.718281828459045", [], [], "UnsignedFloatLiteral")],
    [],
    "unsigned float",
  );
}
  ...
  return new Ast(
    ...
    [
      new Ast(
        ...
        [],
        [],
        (nb >= 0 ? "Unsigned" : "Signed") +
          (Number.isInteger(nb) ? "IntLiteral" : "FloatLiteral"),
      ),
    ],
    [],
    type,
