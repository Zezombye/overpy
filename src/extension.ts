...
import { activatedExtensions, availableExtensionPoints, postInitialLoad } from "./globalVars";
import { OWLanguage, ow_languages } from "./types.d";
import { allFuncList, constValues, defaultCompList, defaultConstCompletionLists, fillAutocompletionEnums, fillAutocompletionMacros, fillAutocompletionSubroutines, fillAutocompletionVariables, memberCompletionItems, metaRuleParamsCompList, preprocessingDirectivesList, refreshAutoComplete, setActivatedExtensions, setAvailableExtensionPoints, setSpentExtensionPoints, spentExtensionPoints, stringEntitiesCompList } from "./autocomplete";
                ...
                if (context.triggerCharacter === '.') {
                    ...
                    if (range === undefined) {
                        ...
                        if (word in constValues) {
                            ...
                            return defaultConstCompletionLists[word];
